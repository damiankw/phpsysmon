...
$sm_lang = array(
 ...
 servers that have been assigned to them.',
    ...
    'servers' => array(
        ...
        'import_description' => 'Bulk Import allows you to import multiple servers at once, saving on administrative time. See the <a href="/src/templates/default/static/assets/example.import-server.csv">Example CSV</a> for an example of how to import. Label, DomainIP, Type and Port are required fields, all other fields will be marked as a default if not entered.',
        'latency' => 'Latency',
        ...
        'error_server_cant_add' => 'Unable to add server on line %s.',
